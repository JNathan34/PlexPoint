...
var init_utils = __esm({
  "../node_modules/unenv/dist/runtime/_internal/utils.mjs"() {
    init_functionsRoutes_0_6896880096788067();
...
async function complete(request, db, fetcher) {
  ...
  if (!linked) statements.push(db.prepare("INSERT INTO plex_identities(plex_id, user_id, username, linked_at, avatar_url) VALUES (?, ?, ?, ?, ?)").bind(profile3.id, row.id, profile3.username, now, profile3.avatarUrl || null));
  else statements.push(db.prepare("UPDATE plex_identities SET username = ?, avatar_url = ? WHERE plex_id = ?").bind(profile3.username, profile3.avatarUrl || null, profile3.id));
  try {
...
// ../.wrangler/tmp/pages-YOapj5/functionsRoutes-0.6896880096788067.mjs
var routes;
var init_functionsRoutes_0_6896880096788067 = __esm({
  "../.wrangler/tmp/pages-YOapj5/functionsRoutes-0.6896880096788067.mjs"() {
    init_billing2();
    init_users();
    init_action();
