...
import { FREE_TRIAL_URL, NAVBAR_HEIGHT, NAV_ITEMS, scrollToSection } from "@/lib/constants";
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Button asChild className="btn-primary-gradient h-11 rounded-full px-5 font-semibold">
              <a href={FREE_TRIAL_URL} target="_blank" rel="noopener noreferrer" data-testid="nav-free-trial-link">
                ...
                <div className="py-4 mt-4 border-t border-border/50">
                  <div className="flex flex-col space-y-1">
                    <a
                      ...
                      className="mb-2 flex min-h-[48px] items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-primary-foreground"
                      data-testid="mobile-free-trial-link"
                    >
                      <Gift className="h-4 w-4" />
                      Start 24-hour trial
                    </a>
