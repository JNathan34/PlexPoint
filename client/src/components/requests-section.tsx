...
export default function RequestsSection() {
  ...
  return (
    <section id="requests" className="py-24 relative overflow-hidden" data-testid="requests-section">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 right-0 w-[600px] h-[600px] rounded-full bg-gradient-to-l from-primary/5 to-transparent blur-3xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              {features.map((feature, index) => (
                <motion.div
                  key={index}
                  variants={item}
                  className="glass-card rounded-2xl p-5 group hover:border-primary/30 transition-all"
                >
                  <div className="flex items-start gap-4">
                    <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-primary to-orange-400 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
            ...
            >
              <Button
                size="lg"
                className="btn-primary-gradient px-8 py-6 text-lg rounded-xl group"
              ...
              <Button
                variant="outline"
                size="lg"
                className="px-8 py-6 text-lg rounded-xl border-border hover:border-primary/50 hover:bg-primary/10 transition-all"
